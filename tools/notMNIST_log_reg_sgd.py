...
#train_step = tf.train.GradientDescentOptimizer(1.3).minimize(cross_entropy)
...
for epoch in range(1000):            # Number of epochs
	random_index = np.random.choice(index, 500) # returns list of random index # define mini-batch size for SGD
